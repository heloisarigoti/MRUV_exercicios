...
if False:
    ...
    def criar_equacao(seed, apenas_int=False,):
        ...
        while True:
            ...
            if (apenas_int == True) and ((4 * a * c) > (b ** 2)) and (resolve_equacao(a, b, c)[0].real.is_integer()) and (resolve_equacao(a, b, c)[1].real.is_integer()) and (-b/(2*a)).is_integer() and (((b*b)-(4*a*c)) <= 1000):
                break
